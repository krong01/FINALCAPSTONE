...
import AddSection from './Admin/Pages/AddSection.jsx';
import TeacherAnnouncement from './Teacher/pages/TeacherAnnouncement.jsx';
import TeacherArticle from './Teacher/pages/TeacherArticle.jsx';
function App() {
  return (
        <Router>
          <Routes>
            ...
            <Route path='/Admin/*' element={
              <>
                ...
                <Routes>
                  ...
                  <Route path='/AddSection/:adminID' element={<AddSection />}/>
                </Routes>
              </>
            } />
            ...
            <Route path='/Teacher/*' element={
              ...
              <Routes>
                ...
                <Route path='/Announcements/:teacherID' element={<TeacherAnnouncement/>} />
                <Route path='/Articles/:teacherID' element={<TeacherArticle/>} />
              </Routes>
              </>
            }/>
          </Routes>
